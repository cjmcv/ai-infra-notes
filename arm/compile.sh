...
/home/shared_dir/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ -O3 -g ./fp32/gemm_kernel.s ./fp32/gemm.cpp -o a.out 
